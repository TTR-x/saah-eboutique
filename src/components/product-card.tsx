...
import { ShoppingCart, CreditCard, Clock, Zap, Check } from 'lucide-react';
      ...
      <CardFooter className="p-3 pt-0 flex items-center gap-3">
        ...
        <div className="flex flex-1 gap-2">
          <Button 
            ...
            size="icon"
            className={cn(
              "rounded-lg border-gray-200 transition-all h-10 w-10 shrink-0",
              isAdded ? "bg-green-50 border-green-200 text-green-600" : "text-gray-700 hover:bg-gray-50"
            )}
